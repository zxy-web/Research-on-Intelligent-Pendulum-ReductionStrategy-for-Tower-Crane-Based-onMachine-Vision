...
def process_data_shift_and_decay(df, x_col='x', angle_col='angle', theta_cols=('theta1', 'theta2'),
    ...
    if x_col in df.columns:
        # Apply smoothing and ensure no values go below original minimum
    ...
    if x_col in df.columns:
        ...
        # After shifting, ensure no values go below 0
...
def plot_each_field_separately(file_paths, output_pdf_dir="plots_pdf"):
    ...
    for field, title, unit in zip(fields, titles, units):
        ...
        pdf_path = os.path.join(output_pdf_dir, f"0.2_{field}.pdf")
...
if __name__ == "__main__":
    input_files = [
        "motion_log_open_loop_traj1_500g_20250405_200137.csv",
        "motion_log_closed_loop_traj2_500g_20250406_124524.csv",
        "motion_log_closed_loop_traj1_500g_20250406_124105.csv",
    ]
    output_dir = "processed"
    closed_loop_file = "motion_log_closed_loop_traj1_500g_20250405_200424.csv"
